...
from MinkowskiEngine.profiler.vision.basic_hooks import *
from MinkowskiEngine.profiler.rnn_hooks import *
...
register_hooks = {
    ...
    ME.MinkowskiConvolution: count_me_conv,
    ME.MinkowskiConvolutionTranspose: count_me_conv,
    ME.MinkowskiGenerativeConvolutionTranspose:count_me_conv,
...
def profile(
    ...
    def dfs_count(module: nn.Module, prefix="\t")->Tuple[int,int]:
