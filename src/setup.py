...
if platform != "linux":
    raise ImportError("Linux is only supported.")
...
include_dirs.extend([str(SRC_PATH), str(PYBIND_PATH), str(SRC_PATH / "3rdparty")])
...
setup(
    ...
    packages=[
        ...
        "MinkowskiEngine.profiler",
        "MinkowskiEngine.profiler.vision",
    ],
    ...
    author="Wanhao Ma",
    author_email="rolfma@163.com",
    zip_safe=False,
    python_requires=">=3.9",
)


def create_compile_commands(build_path="build"):
